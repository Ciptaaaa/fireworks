...
const letters = "HAPPYBIRTHDAYVINDY"; // Define the message you want
...
function createBurst(x, y) {
  // Create one letter
  createParticle(x, y, false); // The false parameter indicates this is not a sparkle

  // Create multiple sparkles
  const numSparkles = 50; // Number of sparkles for each click
  for (let i = 0; i < numSparkles; i++) {
    createParticle(x, y, true); // Sparkles
  }
}
